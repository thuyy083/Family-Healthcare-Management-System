...
namespace HTQL_DV_Y_TE_GIA_DINH.Areas.BacSi.Controllers
{
    public class BacSiHomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var BS = db.BAC_SI_GIA_DINH.Find(taiKhoan.Ma_TK);
            return View(BS);
        }
        ...
        public ActionResult SuaThongTin(int? MaTK)
        {
            ...
            BAC_SI_GIA_DINH BS = db.BAC_SI_GIA_DINH.SingleOrDefault(s => s.Ma_TK == MaTK);
            return View(BS);
        }
        ...
        public ActionResult SuaThongTin(int MaTK)
        {
            var BSUpdate = db.BAC_SI_GIA_DINH.Find(MaTK);
